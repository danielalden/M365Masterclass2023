...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/danielalden/M365Masterclass2023/main/ACME-DC01Config/FirstLastEurope.csv -OutFile C:\temp\FirstLastEurope.csv -UseBasicParsing

#Skapa Share för användare
New-SmbShare -name resources -Path C:\temp -FullAccess "corp\Domain Users"

#Download labfiles
            Start-BitsTransfer -Source https://github.com/danielalden/M365Masterclass2023/raw/main/ACME-DC01Config/Labfiles.zip -Destination C:\Temp
...
#Skapa GPO för local admin på klienter
            ...
            Start-BitsTransfer -Source https://github.com/danielalden/M365Masterclass2023/raw/main/ACME-DC01Config/LocalGPO.zip -Destination C:\Temp
